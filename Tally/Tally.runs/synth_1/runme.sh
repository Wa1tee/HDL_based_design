...
HD_PWD='C:/Users/waitee/Documents/koodit/vivado/HDL_based_design/Tally/Tally.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log tally_tb.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source tally_tb.tcl
