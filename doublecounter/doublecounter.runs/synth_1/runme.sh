...
HD_PWD='C:/Users/waitee/Documents/koodit/vivado/HDL_based_design/doublecounter/doublecounter.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log doublecounter.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source doublecounter.tcl
